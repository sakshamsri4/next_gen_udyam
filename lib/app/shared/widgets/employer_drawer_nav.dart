...
/// A side navigation drawer specifically designed for employer users
///
...
class EmployerDrawerNav extends StatelessWidget {
  /// Creates an employer-specific side navigation drawer
  const EmployerDrawerNav({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      return Drawer(
        ...
        child: Column(
          children: [
            // Employer header with user info if available
            ...
            // Employer badge at the bottom
            _buildEmployerBadge(context, primaryColor),
          ],
        ),
      );
    });
  ...
  /// Build the employer badge at the bottom
  Widget _buildEmployerBadge(BuildContext context, Color primaryColor) {
    return Container(
