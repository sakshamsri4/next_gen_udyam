...
/// A side navigation drawer specifically designed for employee users
///
...
class EmployeeDrawerNav extends StatelessWidget {
  /// Creates an employee-specific side navigation drawer
  const EmployeeDrawerNav({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      return Drawer(
        ...
        child: Column(
          children: [
            // Employee header with user info if available
            ...
            // Employee badge at the bottom
            _buildEmployeeBadge(context, primaryColor),
          ],
        ),
      );
    });
  ...
  /// Build an additional item that doesn't change the selected index
  ...
  /// Build the employee badge at the bottom
  Widget _buildEmployeeBadge(BuildContext context, Color primaryColor) {
    return Container(
